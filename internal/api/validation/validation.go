...
func NewValidator() *Validator {
	...
	registerCustomChecker("tradeStatus", IsTradeStatus, "", validate, translator)
	registerCustomChecker("tradeSide", IsTradeSide, "", validate, translator)
	registerCustomChecker("tradeInstrumentType", IsTradeInstrumentType, "", validate, translator)
	registerCustomChecker("tradeExecutionModel", IsTradeExecutionModel, "", validate, translator)
	registerCustomChecker("tradeOrderType", IsTradeOrderType, "", validate, translator)
	registerCustomChecker("tradeTimeInForce", IsTradeTimeInForce, "", validate, translator)
