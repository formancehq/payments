...
var _ = Describe("API v3 Payment Initiation Creation", func() {
	...
	Context("create payment initiation", func() {
		...
		DescribeTable("validation errors",
			...
			Entry("asset is invalid", PaymentInitiationsCreateRequest{Reference: "asset_invalid", ConnectorID: testConnectorID().String(), SourceAccountID: &sourceID, DestinationAccountID: &destID, Type: "PAYOUT", Amount: big.NewInt(1717), Asset: "USD/-1", ScheduledAt: time.Now().Add(time.Hour)}),
