...
func (t PaymentStatus) String() string {
	...
	case PAYMENT_STATUS_REFUNDED:
		return "REFUNDED"
	case PAYMENT_STATUS_RETURNED:
		return "RETURNED"
	case PAYMENT_STATUS_REVERSED:
		return "REVERSED"
	case PAYMENT_STATUS_REFUNDED_FAILURE:
		return "REFUNDED_FAILURE"
	case PAYMENT_STATUS_REFUND_REVERSED:
	...
	case PAYMENT_STATUS_CAPTURE:
		return "CAPTURE"
	case PAYMENT_STATUS_CAPTURE_FAILED:
...
func PaymentStatusFromString(value string) (PaymentStatus, error) {
	...
	case "REVERSED":
		return PAYMENT_STATUS_REVERSED, nil
	case "RETURNED":
		return PAYMENT_STATUS_RETURNED, nil
	case "REFUNDED_FAILURE":
		return PAYMENT_STATUS_REFUNDED_FAILURE, nil
	case "REFUND_REVERSED":
		return PAYMENT_STATUS_REFUND_REVERSED, nil
	case "DISPUTE":
	...
	case "CAPTURE":
		return PAYMENT_STATUS_CAPTURE, nil
	case "CAPTURE_FAILED":
		return PAYMENT_STATUS_CAPTURE_FAILED, nil
	case "OTHER":
