...
const (
	...
	PAYMENT_INITIATION_ADJUSTMENT_STATUS_PENDING    // PSP acknowledged, waiting for processing
	PAYMENT_INITIATION_ADJUSTMENT_STATUS_PROCESSING // PSP is actively processing
...
func (s PaymentInitiationAdjustmentStatus) String() string {
	...
	case PAYMENT_INITIATION_ADJUSTMENT_STATUS_PENDING:
		return "PENDING"
...
func PaymentInitiationAdjustmentStatusFromString(s string) (PaymentInitiationAdjustmentStatus, error) {
	...
	case "PENDING":
		return PAYMENT_INITIATION_ADJUSTMENT_STATUS_PENDING, nil
	case "PROCESSING":
...
func FromPaymentDataToPaymentInitiationAdjustment(status PaymentStatus, createdAt time.Time, piID PaymentInitiationID) *PaymentInitiationAdjustment {
	...
	case PAYMENT_STATUS_PENDING:
		piStatus = PAYMENT_INITIATION_ADJUSTMENT_STATUS_PENDING
	case PAYMENT_STATUS_PROCESSING, PAYMENT_STATUS_AUTHORISATION:
