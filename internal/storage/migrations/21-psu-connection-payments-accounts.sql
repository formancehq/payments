...
create index if not exists payments_psu_id_idx
  on payments (psu_id);
create index if not exists payments_psu_conn_obc_idx
...
create index if not exists accounts_psu_id_idx
  on accounts (psu_id);
create index if not exists accounts_psu_conn_obc_idx
