...
ALTER TABLE psu_bank_bridges
    RENAME TO open_banking_provider_psus;
ALTER TABLE open_banking_provider_psus
    RENAME CONSTRAINT psu_bank_bridges_pkey TO open_banking_provider_psus_pkey;
ALTER TABLE open_banking_provider_psus
    RENAME CONSTRAINT psu_bank_bridges_connector_id_fk
    TO open_banking_provider_psus_connector_id_fk;
ALTER TABLE open_banking_provider_psus
    RENAME CONSTRAINT psu_bank_bridges_psu_id_fk
    TO open_banking_provider_psus_psu_id_fk;
...
ALTER SEQUENCE psu_bank_bridges_sort_id_seq
    RENAME TO open_banking_provider_psus_sort_id_seq;

-- Open Banking Connections renaming
ALTER TABLE psu_bank_bridge_connections
    RENAME TO psu_open_banking_connections;
ALTER TABLE psu_open_banking_connections
    RENAME CONSTRAINT psu_bank_bridge_connections_pkey TO psu_open_banking_connections_pkey;
ALTER TABLE psu_open_banking_connections
    RENAME CONSTRAINT psu_bank_bridge_connections_psu_id_fk
    TO psu_open_banking_connections_psu_id_fk;
ALTER TABLE psu_open_banking_connections
    RENAME CONSTRAINT psu_bank_bridge_connections_connector_id_fk
    TO psu_open_banking_connections_connector_id_fk;
ALTER INDEX psu_bank_bridge_connections_connector_id
    RENAME TO psu_open_banking_connections_connector_id;
ALTER INDEX psu_bank_bridge_connections_psu_id
    RENAME TO psu_open_banking_connections_psu_id;
ALTER INDEX psu_bank_bridge_connections_created_at_sort_id
    RENAME TO psu_open_banking_connections_created_at_sort_id;;
ALTER SEQUENCE psu_bank_bridge_connections_sort_id_seq
    RENAME TO psu_open_banking_connections_sort_id_seq;

-- Psu OpenBanking access tokens renaming
ALTER TABLE psu_bank_bridge_access_tokens
    RENAME TO psu_open_banking_access_tokens;
ALTER TABLE psu_open_banking_access_tokens
    RENAME CONSTRAINT psu_bank_bridge_access_tokens_pkey TO psu_open_banking_access_tokens_pkey;
ALTER TABLE psu_open_banking_access_tokens
    RENAME CONSTRAINT psu_bank_bridge_access_tokens_psu_id_fk
    TO psu_open_banking_access_tokens_psu_id_fk;
ALTER TABLE psu_open_banking_access_tokens
    RENAME CONSTRAINT psu_bank_bridge_access_tokens_connector_id_fk
    TO psu_open_banking_access_tokens_connector_id_fk;
ALTER SEQUENCE psu_bank_bridge_access_tokens_sort_id_seq
    RENAME TO psu_open_banking_access_tokens_sort_id_seq;
