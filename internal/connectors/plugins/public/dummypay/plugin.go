...
func init() {
	registry.RegisterPlugin(registry.DummyPSPName, func(_ context.Context, _ models.ConnectorID, name string, logger logging.Logger, rm json.RawMessage) (models.Plugin, error) {
