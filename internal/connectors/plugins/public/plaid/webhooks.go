...
func (p *Plugin) handleLinkWebhook(ctx context.Context, req models.TranslateWebhookRequest, baseWebhook client.BaseWebhooks) ([]models.WebhookResponse, error) {
	...
	case "ITEM_ADD_RESULT":
		fmt.Println("handleItemAddResultWebhook", string(req.Webhook.Body))
		// return p.handleItemAddResultWebhook(ctx, req)
...
func (p *Plugin) handleItemAddResultWebhook(ctx context.Context, req models.TranslateWebhookRequest) ([]models.WebhookResponse, error) {
