...
const (
	...
	IncreaseRouteIDMetadataKey                  = increaseMetadataSpecNamespace + "route_id"
	IncreaseRouteTypeMetadataKey                = increaseMetadataSpecNamespace + "route_type"
	IncreaseSourceCategoryMetadataKey           = increaseMetadataSpecNamespace + "source"
	IncreaseTransactionIDMetadataKey            = increaseMetadataSpecNamespace + "transactionID"
	IncreaseDestinationTransactionIDMetadataKey = increaseMetadataSpecNamespace + "destinationTransactionID"
	...
	IncreaseLine1MetadataKey                    = increaseMetadataSpecNamespace + "line1"
