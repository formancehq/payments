...
func (w Workflow) updateUserLink(
	...
	webhookBaseURL, err := utils.GetWebhookBaseURL(w.stackPublicURL, updateUserLink.ConnectorID)
	if err != nil {
	...
	resp, err := activities.PluginUpdateUserLink(
		infiniteRetryContext(ctx),
		updateUserLink.ConnectorID,
		models.UpdateUserLinkRequest{
