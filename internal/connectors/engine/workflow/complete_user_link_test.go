...
func (s *UnitTestSuite) Test_CompleteUserLink_Success() {
	...
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionAttemptsGetActivity, mock.Anything, attemptID).Once().Return(attempt, nil)
	...
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionAttemptsStoreActivity, mock.Anything, mock.Anything).Once().Return(nil)
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionsStoreActivity, mock.Anything, psuID, mock.Anything).Times(2).Return(nil)
...
func (s *UnitTestSuite) Test_CompleteUserLink_StoragePSUOpenBankingConnectionAttemptsGet_Error() {
	...
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionAttemptsGetActivity, mock.Anything, attemptID).Once().Return(
		nil,
...
func (s *UnitTestSuite) Test_CompleteUserLink_StoragePSUOpenBankingConnectionAttemptsStore_Error_OnFailure() {
	...
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionAttemptsStoreActivity, mock.Anything, mock.Anything).Once().Return(
...
func (s *UnitTestSuite) Test_CompleteUserLink_StoragePSUOpenBankingConnectionsStore_Error() {
	...
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionAttemptsStoreActivity, mock.Anything, mock.Anything).Once().Return(nil)
	s.env.OnActivity(activities.StoragePSUOpenBankingConnectionsStoreActivity, mock.Anything, psuID, mock.Anything).Once().Return(
