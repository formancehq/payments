...
func (s *UnitTestSuite) Test_CreateWebhooks_Success() {
	s.env.OnActivity(activities.PluginCreateWebhooksActivity, mock.Anything, mock.Anything).Return(func(ctx context.Context, req activities.CreateWebhooksRequest) (*models.CreateWebhooksResponse, error) {
	...
	s.env.OnWorkflow(Run, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(nil)
...
func (s *UnitTestSuite) Test_CreateWebhooks_PluginCreateWebhooksActivity_Error() {
	s.env.OnActivity(activities.PluginCreateWebhooksActivity, mock.Anything, mock.Anything).Return(
		nil,
...
func (s *UnitTestSuite) Test_CreateWebhooks_Run_Error() {
	...
	s.env.OnWorkflow(Run, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(
