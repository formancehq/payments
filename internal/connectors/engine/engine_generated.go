...
func (m *MockEngine) CreatePaymentServiceUserLink(ctx context.Context, psuID uuid.UUID, connectorID models.ConnectorID, idempotencyKey *uuid.UUID, ClientRedirectURL *string) (models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePaymentServiceUserLink", ctx, psuID, connectorID, idempotencyKey, ClientRedirectURL)
...
func (mr *MockEngineMockRecorder) CreatePaymentServiceUserLink(ctx, psuID, connectorID, idempotencyKey, ClientRedirectURL any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatePaymentServiceUserLink", reflect.TypeOf((*MockEngine)(nil).CreatePaymentServiceUserLink), ctx, psuID, connectorID, idempotencyKey, ClientRedirectURL)
}
...
func (m *MockEngine) ForwardPaymentServiceUser(ctx context.Context, psuID uuid.UUID, connectorID models.ConnectorID) (models.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) UpdatePaymentServiceUserLink(ctx context.Context, psuID uuid.UUID, connectorID models.ConnectorID, connectionID string, idempotencyKey *uuid.UUID, ClientRedirectURL *string) (models.Task, error) {
	m.ctrl.T.Helper()
