...
// Source: /Users/fabriceguery/go/pkg/mod/go.temporal.io/sdk@v1.35.0/client/client.go
//
// Generated by this command:
//
//	mockgen -package activities -source /Users/fabriceguery/go/pkg/mod/go.temporal.io/sdk@v1.35.0/client/client.go -destination internal/connectors/engine/activities/client_generated.go
//
...
func (mr *MockNamespaceClientMockRecorder) Describe(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNamespaceClientMockRecorder) Register(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNamespaceClientMockRecorder) Update(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
