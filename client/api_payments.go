...
func (r ApiListAccountsRequest) Limit(limit interface{}) ApiListAccountsRequest {
	r.limit = &limit
	return r
}

// How many accounts to skip, pagination can be achieved in conjunction with &#39;limit&#39; parameter.
func (r ApiListAccountsRequest) Skip(skip interface{}) ApiListAccountsRequest {
	r.skip = &skip
	return r
}

// Field used to sort payments (Default is by date).
func (r ApiListAccountsRequest) Sort(sort interface{}) ApiListAccountsRequest {
	r.sort = &sort
	return r
}
