...
const (
	...
	V3UpdateConnectorRequestTypeGocardless    V3UpdateConnectorRequestType = "Gocardless"
...
func CreateV3UpdateConnectorRequestGocardless(gocardless V3GocardlessConfig) V3UpdateConnectorRequest {
	typ := V3UpdateConnectorRequestTypeGocardless
...
func (u *V3UpdateConnectorRequest) UnmarshalJSON(data []byte) error {
	...
	case "Gocardless":
		...
		if err := utils.UnmarshalJSON(data, &v3GocardlessConfig, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Provider == Gocardless) type V3GocardlessConfig within V3UpdateConnectorRequest: %w", string(data), err)
		}

		u.V3GocardlessConfig = v3GocardlessConfig
		u.Type = V3UpdateConnectorRequestTypeGocardless
		return nil
	case "Mangopay":
