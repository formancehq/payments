...
type V3ListConnectorSchedulesRequest struct {
	...
	V3ConnectorSchedulesQueryBuilder *components.V3ConnectorSchedulesQueryBuilder `request:"mediaType=application/json"`
}
...
func (o *V3ListConnectorSchedulesRequest) GetV3ConnectorSchedulesQueryBuilder() *components.V3ConnectorSchedulesQueryBuilder {
	if o == nil {
		return nil
	}
	return o.V3ConnectorSchedulesQueryBuilder
}
