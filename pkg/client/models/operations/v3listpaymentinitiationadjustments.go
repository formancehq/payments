...
type V3ListPaymentInitiationAdjustmentsRequest struct {
	...
	V3PaymentInitiationAdjustmentsQueryBuilder *components.V3PaymentInitiationAdjustmentsQueryBuilder `request:"mediaType=application/json"`
}
...
func (o *V3ListPaymentInitiationAdjustmentsRequest) GetV3PaymentInitiationAdjustmentsQueryBuilder() *components.V3PaymentInitiationAdjustmentsQueryBuilder {
	if o == nil {
		return nil
	}
	return o.V3PaymentInitiationAdjustmentsQueryBuilder
}
