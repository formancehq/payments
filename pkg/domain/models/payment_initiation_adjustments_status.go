...
const (
	...
	// PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED means the PSP refused
	// the initiation outright, or the request never reached it: it was never
	// processed. FAILED keeps the narrower meaning of "it was being processed,
	// then it broke".
	PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED
)
...
func (s PaymentInitiationAdjustmentStatus) String() string {
	...
	case PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED:
...
func PaymentInitiationAdjustmentStatusFromString(s string) (PaymentInitiationAdjustmentStatus, error) {
	...
	case "NOT_INITIATED":
		return PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED, nil
	case "UNKNOWN":
