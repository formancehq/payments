...
func TestPaymentInitiationAdjustmentStatus(t *testing.T) {
	...
	t.Run("String", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{models.PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED, "NOT_INITIATED"},
	...
	t.Run("PaymentInitiationAdjustmentStatusFromString", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{"NOT_INITIATED", models.PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED, false},
	...
	t.Run("Scan", func(t *testing.T) {
		...
		err = status.Scan("NOT_INITIATED")
		// Then
		require.NoError(t, err)
		assert.Equal(t, models.PAYMENT_INITIATION_ADJUSTMENT_STATUS_NOT_INITIATED, status)
