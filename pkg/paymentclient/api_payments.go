...
func (r ApiCreatePaymentRequest) PaymentData(paymentData PaymentData) ApiCreatePaymentRequest {
...
/*
CreatePayment Returns a list of payments.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId
 @return ApiCreatePaymentRequest
*/
func (a *PaymentsApiService) CreatePayment(ctx _context.Context, organizationId string) ApiCreatePaymentRequest {
	return ApiCreatePaymentRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return Payment
func (a *PaymentsApiService) CreatePaymentExecute(r ApiCreatePaymentRequest) (Payment, *_nethttp.Response, error) {
	var (
...
func (r ApiUpdatePaymentRequest) PaymentData(paymentData PaymentData) ApiUpdatePaymentRequest {
	r.paymentData = &paymentData
	return r
}
func (r ApiUpdatePaymentRequest) Upsert(upsert bool) ApiUpdatePaymentRequest {
	r.upsert = &upsert
	return r
}

func (r ApiUpdatePaymentRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.UpdatePaymentExecute(r)
}

/*
UpdatePayment Update a payment (can upsert)
...
*/
func (a *PaymentsApiService) UpdatePayment(ctx _context.Context, organizationId string, paymentId string) ApiUpdatePaymentRequest {
	return ApiUpdatePaymentRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
func (a *PaymentsApiService) UpdatePaymentExecute(r ApiUpdatePaymentRequest) (*_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/organizations/{organizationId}/payments/{paymentId}"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", _neturl.PathEscape(parameterToString(r.organizationId, "")), -1)
