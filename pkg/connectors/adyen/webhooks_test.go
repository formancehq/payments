...
var _ = Describe("Adyen Plugin Accounts", func() {
	...
	Context("translating webhooks", func() {
		...
		It("should handle authorization", func(ctx SpecContext) {
			expectedPSPPayment := connector.PSPPayment{
				Reference:                   "test",
				CreatedAt:                   now,
				Type:                        connector.PAYMENT_TYPE_PAYIN,
				Amount:                      big.NewInt(100),
				Asset:                       "EUR/2",
				Scheme:                      connector.PAYMENT_SCHEME_CARD_VISA,
...
func comparePayments(a, b connector.PSPPayment) {
