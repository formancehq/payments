...
func (c *client) InitiatePayout(ctx context.Context, pr *PayoutRequest) (*PayoutResponse, error) {
	...
	payoutType := connector.ExtractNamespacedMetadata(pr.Metadata, ColumnPayoutTypeMetadataKey)
	...
	case "ach":
		achPayload := &ACHPayoutRequest{
			...
			Type:                              connector.ExtractNamespacedMetadata(pr.Metadata, ColumnTypeMetadataKey),
			EffectiveDate:                     connector.ExtractNamespacedMetadata(pr.Metadata, ColumnEffectiveDateMetadataKey),
			SameDay:                           connector.ExtractNamespacedMetadata(pr.Metadata, ColumnSameDayMetadataKey),
			CompanyDiscretionaryData:          connector.ExtractNamespacedMetadata(pr.Metadata, ColumnCompanyDiscretionaryDataMetadataKey),
			CompanyEntryDescription:           connector.ExtractNamespacedMetadata(pr.Metadata, ColumnCompanyEntryDescriptionMetadataKey),
			CompanyName:                       connector.ExtractNamespacedMetadata(pr.Metadata, ColumnCompanyNameMetadataKey),
			...
			UltimateOriginatorAccountNumber:   connector.ExtractNamespacedMetadata(pr.Metadata, ColumnUltimateOriginatorAccountNumberMetadataKey),
			UltimateOriginatorCounterpartyId:  connector.ExtractNamespacedMetadata(pr.Metadata, ColumnUltimateOriginatorCounterpartyIdMetadataKey),
		}
	...
	case "international-wire":
		internationalPayload := &InternationalWirePayoutRequest{
			...
			Description:              pr.Description,
			BankAccountID:            pr.SourceAccount,
			ChargeBearer:             connector.ExtractNamespacedMetadata(pr.Metadata, ColumnChargeBearerMetadataKey),
			AllowOverdraft:           connector.ExtractNamespacedMetadata(pr.Metadata, ColumnAllowOverdraftMetadataKey) == "true",
			FxQuoteID:                connector.ExtractNamespacedMetadata(pr.Metadata, ColumnFxQuoteIdMetadataKey),
			IntermediaryBank:         connector.ExtractNamespacedMetadata(pr.Metadata, ColumnIntermediaryBankMetadataKey),
			MessageToBeneficiaryBank: connector.ExtractNamespacedMetadata(pr.Metadata, ColumnMessageToBeneficiaryBankMetadataKey),
			RemittanceInfo: RemittanceInfoRequest{
				GeneralInfo:          connector.ExtractNamespacedMetadata(pr.Metadata, ColumnGeneralInfoMetadataKey),
				BeneficiaryReference: connector.ExtractNamespacedMetadata(pr.Metadata, ColumnBeneficiaryReferenceMetadataKey),
				PurposeCode:          connector.ExtractNamespacedMetadata(pr.Metadata, ColumnPurposeCodeMetadataKey),
			},
		}
	...
	case "realtime":
		realtimePayload := &RealtimeTransferRequest{
			...
			BankAccountID:                pr.SourceAccount,
			AllowOverdraft:               connector.ExtractNamespacedMetadata(pr.Metadata, ColumnAllowOverdraftMetadataKey) == "true",
			UltimateDebtorCounterparty:   connector.ExtractNamespacedMetadata(pr.Metadata, ColumnUltimateDebtorCounterpartyMetadataKey),
			UltimateDebtorCounterpartyID: connector.ExtractNamespacedMetadata(pr.Metadata, ColumnUltimateDebtorCounterpartyIdMetadataKey),
			EndToEndID:                   connector.ExtractNamespacedMetadata(pr.Metadata, ColumnEndToEndIdMetadataKey),
		}
