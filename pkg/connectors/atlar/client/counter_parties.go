...
func (c *client) PostV1CounterParties(ctx context.Context, newExternalBankAccount connector.BankAccount) (*counterparties.PostV1CounterpartiesCreated, error) {
...
func extractAtlarAccountIdentifiersFromBankAccount(bankAccount connector.BankAccount) []*atlar_models.AccountIdentifier {
