...
var _ = Describe("BankingCircle Plugin Payouts Creation", func() {
	...
	Context("create payout", func() {
		var (
			...
			samplePSPPaymentInitiationMissingMetadata connector.PSPPaymentInitiation
			now                                       time.Time
		)
			...
			samplePSPPaymentInitiation = connector.PSPPaymentInitiation{
				...
				DestinationAccount: &connector.PSPAccount{
					...
					Metadata: map[string]string{
						connector.AccountIBANMetadataKey:               "iban",
						connector.AccountAccountNumberMetadataKey:      "acc",
						connector.AccountSwiftBicCodeMetadataKey:       "bic",
						connector.AccountBankAccountCountryMetadataKey: "US",
					},
				},
