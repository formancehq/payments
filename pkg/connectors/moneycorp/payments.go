...
func (p *Plugin) transactionToPayment(ctx context.Context, transaction *client.Transaction) (*connector.PSPPayment, error) {
...
func (p *Plugin) fetchAndTranslateTransfer(ctx context.Context, transaction *client.Transaction) (*connector.PSPPayment, error) {
...
func matchPaymentType(transactionType string, transactionDirection string) (connector.PaymentType, bool) {
	switch transactionType {
	case "Transfer":
		return connector.PAYMENT_TYPE_TRANSFER, true
	case "Payment", "Exchange", "Charge", "Refund":
		switch transactionDirection {
		case "Debit":
			return connector.PAYMENT_TYPE_PAYOUT, true
		case "Credit":
			return connector.PAYMENT_TYPE_PAYIN, true
		}
	}

	return connector.PAYMENT_TYPE_OTHER, false
}
