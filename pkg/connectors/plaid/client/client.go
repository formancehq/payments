...
func New(name, clientID, clientSecret string, connectorID connector.ConnectorID, isSandbox bool) (Client, error) {
	...
	configuration.HTTPClient = metrics.NewHTTPClient(name, connector.DefaultConnectorClientTimeout)
