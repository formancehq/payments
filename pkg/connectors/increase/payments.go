...
func (p *Plugin) processPaymentTypes(ctx context.Context, state *paymentsState, payments []connector.PSPPayment, pageSize int) ([]connector.PSPPayment, bool, error) {
	var err error
...
func (p *Plugin) fillPayments(
	...
	pageSize int,
	status connector.PaymentStatus,
...
func (p *Plugin) processPendingPayments(ctx context.Context, state *paymentsState, payments []connector.PSPPayment, pageSize int) ([]connector.PSPPayment, error) {
	...
	payments, err = p.fillPayments(pagedPendingTransactions, payments, pageSize, connector.PAYMENT_STATUS_PENDING)
	if err != nil {
		return nil, err
	}
...
func (p *Plugin) processSucceededPayments(ctx context.Context, state *paymentsState, payments []connector.PSPPayment, pageSize int) ([]connector.PSPPayment, error) {
	...
	payments, err = p.fillPayments(pagedTransactions, payments, pageSize, connector.PAYMENT_STATUS_SUCCEEDED)
	if err != nil {
		return nil, err
	}
...
func (p *Plugin) processDeclinedPayments(ctx context.Context, state *paymentsState, payments []connector.PSPPayment, pageSize int) ([]connector.PSPPayment, error) {
	...
	payments, err = p.fillPayments(pagedDeclinedTransactions, payments, pageSize, connector.PAYMENT_STATUS_FAILED)
	if err != nil {
		return nil, err
	}
...
func (p *Plugin) mapPayment(transaction *client.Transaction, status connector.PaymentStatus) (connector.PSPPayment, error) {
...
func fillParentReference(transaction *client.Transaction, pspPayment connector.PSPPayment) connector.PSPPayment {
...
func mapTransactionStatus(transactionType string, status connector.PaymentStatus) connector.PaymentStatus {
