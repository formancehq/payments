...
func assertErrorResponse(resp connector.FetchNextExternalAccountsResponse, err error, expectedError error) {
...
func assertSuccessResponse(
	resp connector.FetchNextExternalAccountsResponse,
	err error,
...
func assertBeneficiaryMapping(beneficiary client.Beneficiary, resultingPSPAccount connector.PSPAccount) {
