...
func transactionTypeToPaymentType(txType string) models.PaymentType {
	...
	case "CONVERSION", "INTERNAL_DEPOSIT", "INTERNAL_WITHDRAWAL",
		"DELEGATION", "UNDELEGATION", "STAKE", "RESTAKE", "PORTFOLIO_STAKE", "UNSTAKE", "PORTFOLIO_UNSTAKE":
	...
	case "KEY_REGISTRATION", "COMPLETE_UNBONDING", "WITHDRAW_UNBONDED", "STAKE_ACCOUNT_CREATE", "CHANGE_VALIDATOR",
		"REMOVE_AUTHORIZED_PARTY", "STAKE_AUTHORIZE_WITH_SEED", "SLASH", "VOTE_AUTHORIZE", "ONCHAIN_TRANSACTION":
